    ...
    return (
        <Grid container spacing={0} sx={{ background: `linear-gradient(0deg, rgba(0,0,0,1) 0%, rgba(53,34,198,0.47102591036414565) 100%),url(${img_url}),black`, minHeight: '100vh'}}>
            ...
            <>
                ...
                <Grid item sm={12} xs={12} md={12} lg={12} xl={12} sx={{ display:'flex',flexDirection:(xsmall?'column':'row'),  padding: '6em' }}>
                    <Grid item sm={12} xs={12} md={6} lg={4} xl={3.5}>
                        {/*Poster */}
                    ...
                    <Grid item sm={12} xs={12} md={9} lg={12} xl={9}>



                        <Grid item sm={12} xs={12} md={12} lg={12} xl={12} sx={{ paddingLeft: (xsmall?'0em':'4em'), paddingTop:(xsmall?'1em':'0em') }}>
                            <Typography variant={(xsmall?'h2':'h1')} sx={{ color: '#fff', fontFamily: 'Bebas', lineHeight:'0.9'}}>{movie.title} {"(" + date.getFullYear() + ")"}</Typography>
                            ...
                            <Grid container spacing={5} sx={{ marginTop:'1em',justifyContent: 'center', alignItems: 'center', display: 'flex' }}>
                                ...
                                <Grid item sm={12} xs={12} md={6} xl={6} sx={{ justifyContent: 'left', alignItems: 'left' }}>
                                ...
                                <Grid item sm={12} xs={12} md={6} xl={6} sx={{ justifyContent: 'right', alignItems: 'right' }}>
